...
cqlsh $SINGLE_SEED -f /cornerstone/cql/datastax/demo-portal/ticker.cql

# create symlinks to Cornerstone project's templates and static files in the new project
ln -s /cornerstone/web/datastax/cornerstone-python/Cornerstone/templates /cornerstone/web/datastax/demo-portal/
ln -s /cornerstone/web/datastax/cornerstone-python/Cornerstone/static /cornerstone/web/datastax/demo-portal/

# start webserver, with logging
(
    nohup /cornerstone/web/datastax/demo-portal/run > ${HOME}/flask.log 2>&1
) &
